...
# lockgen = [r'/home/newuser/Desktop/saliva/key1st_saliva_.csv',
#            r'/home/newuser/Desktop/saliva/keysaliva_785n.csv',
#           r'/home/newuser/Desktop/saliva/keymilk_785nm_.csv']

# keygen =[r'/home/newuser/Desktop/saliva/keysaliva_785n.csv',
#           r'/home/newuser/Desktop/saliva/keymilk_785nm_.csv']
...
def FilePeakMatching(keygen,lockgen,tol):
    ...
    plotpoints(dataset)
    centerpointplots(dataset,len(df1['label'].unique()))
...
def checklabelloc(data,c):
    ...
    return len(label) < len(set(label))+3
    ...
    for i in range(shape):
        ...
        for c in clusters:
            if len(c)==iterate and checklabelloc(data,c):
                ...
                for cs in c:
                    index = data['center']==cs
                    x.append(data['label'][index].values[0])
