...
import analysisFunctions_v06 as af
        ...
        if not inputFilePath:         
            self.nofile_warning_applications()
             ...
             if self.LoadingsCheckBox.isChecked() and self.GaussianCheckBox.isChecked() and self.DistanceCheckBox.isChecked():
                wavenumber,dataset,target,flag = af.sortData(inputFilePath,asymmetry_param, smoothness_param, max_iters, conv_thresh,z)
                ...
                if len(target)< 2 or len(dataset) <2:
                    ...
                    af.PCAPlot2D(finalDf,targets,info,1)
                    af.LoadingsPlot2D(wavenumber,pca)
                    distance = af.DistanceBarPlot2D(finalDf,targets,stylestring)
                ...
                if len(target)< 2 or len(dataset) <2:
                    ...
                    finalDf,targets,info,pca,wavenumber = af.OrganizePCAData(dataset,target,wavenumber,windowmin,windowmax)
                    af.PCAPlot2D(finalDf,targets,info,0)
                    af.LoadingsPlot2D(wavenumber,pca)
       ...
       #flag 1 gaussian plot flag 0 no gaussian plot
            ...
            if self.LoadingsCheckBox.isChecked() and self.GaussianCheckBox.isChecked() and self.DistanceCheckBox.isChecked():
                ...
                if len(target)< 2 or len(dataset) <2:
                    ...
                    finalDf,targets,info,pca,wavenumber = af.OrganizePCAData(dataset,target,wavenumber,windowmin,windowmax)
                    af.PCAPlot3D(finalDf,targets,info,1,ax)
                    af.LoadingsPlot3D(wavenumber,pca)
                    distance = af.DistanceBarPlot3D(finalDf,targets,stylestring)
                ...
                if len(target)< 2 or len(dataset) <2:
                    ...
                    finalDf,targets,info,pca,wavenumber = af.OrganizePCAData(dataset,target,wavenumber,windowmin,windowmax)
                    af.PCAPlot3D(finalDf,targets,info,0,ax)
                    af.LoadingsPlot3D(wavenumber,pca)
