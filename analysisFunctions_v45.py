...
#            colours.append(cycle[i%len(cycle)])
        ...
        NUM_COLORS = len(len(list(np.unique(target))))
...
# lockgen = [r'C:\Users\paulo\OneDrive - University of Birmingham\Desktop\birmingham_02\saliva\GUI for raman analysis\key1st_saliva_.csv',
#            r'C:\Users\paulo\OneDrive - University of Birmingham\Desktop\birmingham_02\saliva\GUI for raman analysis\key2nd_saliva_.csv',
#           r'C:\Users\paulo\OneDrive - University of Birmingham\Desktop\birmingham_02\saliva\GUI for raman analysis\key10st_saliva.csv',
...
#
# keygen =[r'C:\Users\paulo\OneDrive - University of Birmingham\Desktop\birmingham_02\saliva\GUI for raman analysis\keysaliva_785n.csv',
#          r'C:\Users\paulo\OneDrive - University of Birmingham\Desktop\birmingham_02\saliva\GUI for raman analysis\keymilk_785nm_.csv']
#
# tol = 5
...
#    name2 = lockgen[0].split('\\')[-1]
    ...
    plotpoints(dataset2)
    centerpointplots(dataset2,len(df1['label'].unique()))
...
def plotpoints(dataset):
    ...
    plt.figure()
    for name in dataset['label'].unique():
        if name.split(' ')[0] != name0:
            plt.figure()
            index = name == dataset['label']
            plt.plot(dataset['center'][index],dataset['ratio'][index],'-o',label=name)
            name0 = name.split(' ')[0]
        else:
            index = name == dataset['label']
            plt.plot(dataset['center'][index],dataset['ratio'][index],'-o',label=name)
...
def centerpointplots(dataset,shape):
    ...
    for i in range(shape):
        ...
        clusters = cluster(sorted(data['center'].values),1)
