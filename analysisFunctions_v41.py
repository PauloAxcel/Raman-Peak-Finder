...
#inv=0  
#    
#keygen = [r'C:\Users\paulo\OneDrive - University of Birmingham\Desktop\birmingham_02\saliva\saliva data\milk\1st_saliva_785nm_static1150_3s_3acc_10%_50x_map24_toothpickv02.txt',
    ...
    for i in range(properties.shape[0]):
        ...
        if math.isnan(properties.iloc[i,2:].values[0]):
            ...
            while(l>l*i/neuron):
                ...
                rect2 = patches.Rectangle((patchx+i*l/neuron, patchy) , l/neuron , w, edgecolor='k', facecolor='none')
                rect3 = patches.Rectangle((patchx, patchy+i*w/neuron) , l , w/neuron, edgecolor='k', facecolor='none')
                ax.add_patch(rect2)
                ax.add_patch(rect3)
                i = i + 1
